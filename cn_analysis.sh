...
#$ -wd /mnt/projects/mslim/ITH/bin/sclust/output/cn_analysis/
#$ -N sclust
#$ -o stdout/
...
#    done
#mkdir -p output/cn_analysis
#cd output/bamprocess/
#Sclust bamprocess -i test -o output/test
prefix=pp05
Sclust cn -rc ../bamprocess/$prefix\_rcount.txt -snp ../bamprocess/$prefix\_snps.txt -vcf ../../$prefix.mutations.vcf -o $prefix/_2 -ns 100 -maxp 3
